...
#import "CGLimitedTextView.h"
#import "CGDynamicDelegate.h"
#import "CGMatchManager.h"

@interface CGLimitedTextView (){
...
@implementation CGLimitedTextView
...
- (void)textViewTextDidChangeNotification:(NSNotification *)notification {
    ...
    switch (self.limitedType) {
        case CGLimitedTextViewTypeDefault:
            break;
        case CGLimitedTextViewTypePrice:
            isMatch = [CGMatchManager matchLimitedTextTypePriceWithComponent:textView value:currentText];
            break;
        case CGLimitedTextViewTypeCustom:
            isMatch = [CGMatchManager matchLimitedTextTypeCustomWithRegExs:self.limitedRegExs component:textView value:currentText];
            break;
        default:break;
    }
...
@interface TXDynamicCGLimitedTextViewDelegate: CGDynamicDelegate<UITextViewDelegate>

@end

@implementation TXDynamicCGLimitedTextViewDelegate
...
- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text {
    ...
    if ([textView isKindOfClass:[CGLimitedTextView class]]) {
        CGLimitedTextView *limitedTextView = (CGLimitedTextView *)textView;
        ...
        switch (limitedTextView.limitedType) {
            ...
            case CGLimitedTextViewTypePrice: {
                matchResult = [CGMatchManager matchLimitedTextTypePriceWithComponent:limitedTextView value:matchStr];
            }
                break;
            ...
            case CGLimitedTextViewTypeCustom:{
                if (limitedTextView.isTextSelecting) {// 高亮选中文本判断
                    ...
                    matchResult = [CGMatchManager matchLimitedTextTypeCustomWithRegExs:limitedTextView.limitedRegExs component:limitedTextView value:matchStr];
                }
            }
                break;
