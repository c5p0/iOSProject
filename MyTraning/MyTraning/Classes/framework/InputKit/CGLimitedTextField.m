...
#import "CGMatchManager.h"

@interface CGLimitedTextField (){
...
@implementation CGLimitedTextField
...
- (void)textFieldTextDidChangeNotification:(NSNotification *)notification {
    ...
    if (self.TextFieldNotifiChange) {
        self.TextFieldNotifiChange(textField.text);
    }
    ...
    switch (self.limitedType) {
        case CGLimitedTextFieldTypeDefault:
            break;
        case CGLimitedTextFieldTypePrice:
            isMatch = [CGMatchManager matchLimitedTextTypePriceWithComponent:textField value:currentText];
            break;
        case CGLimitedTextFieldTypeCustom:
         isMatch = [CGMatchManager matchLimitedTextTypeCustomWithRegExs:self.limitedRegExs component:textField value:currentText];
            break;
        default:break;
    }
...
#pragma clang diagnostic pop
    if (self.delegate && [self.delegate.class isSubclassOfClass:[CGDynamicDelegate class]]) {
        CGDynamicDelegate *dynamicDelegate = (CGDynamicDelegate *)self.delegate;
...
@interface TXDynamicCGLimitedTextFieldDelegate: CGDynamicDelegate

@end

@implementation TXDynamicCGLimitedTextFieldDelegate
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if ([textField isKindOfClass:[CGLimitedTextField class]]) {
        CGLimitedTextField *limitedTextField = (CGLimitedTextField *)textField;
        ...
        switch (limitedTextField.limitedType) {
            ...
            case CGLimitedTextFieldTypePrice: {
                matchResult = [CGMatchManager matchLimitedTextTypePriceWithComponent:limitedTextField value:matchStr];
            }
                break;
            ...
            case CGLimitedTextFieldTypeCustom: {
                if (limitedTextField.isTextSelecting) {// 高亮选中文本判断
                    ...
                    matchResult = [CGMatchManager matchLimitedTextTypeCustomWithRegExs:limitedTextField.limitedRegExs component:limitedTextField value:matchStr];
                }
            }
                break;
