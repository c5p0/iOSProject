...
typedef NS_ENUM (NSInteger, CGLimitedTextFieldType) {
    CGLimitedTextFieldTypeDefault,
    CGLimitedTextFieldTypePrice,
    CGLimitedTextFieldTypeCustom
};
...
@interface CGLimitedTextField : UITextField

#if TARGET_INTERFACE_BUILDER
@property (nonatomic, assign) IBInspectable NSInteger limitedType;
#else
/** 限制类型 */
@property (nonatomic, assign) CGLimitedTextFieldType limitedType;
#endif
...
@property (nonatomic,strong) void(^TextFieldNotifiChange)(NSString *content);
