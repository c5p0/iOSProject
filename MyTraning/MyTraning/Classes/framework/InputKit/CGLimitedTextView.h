...
typedef NS_ENUM (NSInteger, CGLimitedTextViewType) {
    CGLimitedTextViewTypeDefault,
    CGLimitedTextViewTypePrice,
    CGLimitedTextViewTypeCustom
};

@interface CGLimitedTextView : UITextView

#if TARGET_INTERFACE_BUILDER
@property (nonatomic, assign) IBInspectable NSInteger limitedType;
#else
/** 限制类型 */
@property (nonatomic, assign) CGLimitedTextViewType limitedType;
#endif
